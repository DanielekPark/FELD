              ...
              <div className="mt-3 flex items-center">
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">
                    This example shown is not an SVG, its HTML and CSS. Clippy
                    is a tool for generating values for shape functions for the
                    new and cool CSS clip-path property.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 bg-white p-6 flex flex-col justify-between">
              ...
              <div className="mt-3 flex items-center">
                <div className="ml-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    Place where you can play with a collection of pre-made CSS
                    animations. You will be able to see how they affect the
