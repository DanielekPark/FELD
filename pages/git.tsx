...
const gitTools = [
  ...
  },
  {
    name: 'Readme So',
    img: readmeso,
    details: 'The easiest way to create a README. An editor allows you to quickly add customize all the sections you need for a readme.',
    link: 'https://readme.so/editor',
  },
  {
    name: 'Git Command Explorer',
    img: gitexplorer,
    details: 'Find the right Git commands you need without digging through the web.',
